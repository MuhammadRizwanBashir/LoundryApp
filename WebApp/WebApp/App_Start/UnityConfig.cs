...
namespace WebApp.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRepositoryAsync<UnHandledErrors>, Repository<UnHandledErrors>>();
            container.RegisterType<IUnHandledErrorsService, UnHandledErrorsService>();
